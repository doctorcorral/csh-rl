...
--   agda src/CSHRL/Tasks/Synthesized/MountainCarSuccessor.agda (MountainCar, honest altitude reward, successor synthesis; ~4 min)
...
--   agda src/CSHRL/Tasks/Synthesized/SudokuNonForced.agda     (non-forced 4x4: survival fails, Finder needed; seconds)
--   agda src/CSHRL/Tasks/Synthesized/Sudoku9NonForced.agda    (non-forced 9x9: survival fails, Finder solves; ~15 min)
