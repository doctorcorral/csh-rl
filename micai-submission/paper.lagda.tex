...
This applies to both conditions: \texttt{CoinductiveHomomorphism}'s successor-value preservation and \texttt{CoindHomo}'s action-value preservation are both pairwise properties that restrict without loss.
...
The examples in this section validate that the formal machinery instantiates correctly.  Each machine-checked development is a proof that the framework applies to that task class.
