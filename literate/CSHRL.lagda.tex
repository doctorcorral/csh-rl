...
The term ``symmetric'' reflects two aspects: (1) action rankings are permutations---elements of the symmetric group $S_{|A|}$; (2) the correspondence between rankings and stream dominance is conjectured to be bidirectional (an isomorphism, not just a homomorphism). The Appendix explores the converse direction as future work.
\end{remark}
