defmodule Synthex.Chain do
  ...
  alias Synthex.ContinuousFeatures
  alias Synthex.CEGIS
  ...
  #
  # Accumulates (max_penalty - penalty) per surviving step.
  # Terminal states yield 0 reward for remaining steps (natural crash
  # penalty without the arbitrary crash_penalty constant).
  ...
  defp solve_stage(stage_action, default, chain_so_far, env_mod, eval_fn, opts) do
    ...
    IO.puts("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
    IO.puts("  Stage: #{inspect(stage_action)} vs chain fallback")
  ...
  # CEGAR rounds expand the feature pool using trajectories from the best-so-far policy
  ...
  def solve(env_mod, action_priority, default_action, opts \\ []) do
    ...
    IO.puts("\n══════════════════════════════════════════════════════")
    IO.puts("  CHAIN SYNTHESIS COMPLETE")
    IO.puts("══════════════════════════════════════════════════════")
