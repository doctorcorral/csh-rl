defmodule Synthex.PerStateRanking do
  @moduledoc """
  ...
  def determine_rankings(chain, default_action, opts) do
    ...
    # Build initial full-ranking partition from chain:
    # top action first, rest in arbitrary order
    initial_partition =
    ...
    # Analyze results — region-level aggregation
    ...
    # Build final partition from aggregated rankings
    final_pred_rankings =
      initial_partition
      |> Enum.with_index()
  ...
  def exhaustive_rankings(chain, default_action, opts) do
    ...
    # Extract predicates and top actions from chain
    ...
    # Take the best and validate on held-out seeds
