defmodule Synthex.Permutation.Engine do
  @moduledoc """
  ...
  alias Synthex.Permutation.Oracle
  ...
  def solve(env_mod, depth \\ 1, max_coeff \\ 1) do
    ...
    all_traj = Enum.flat_map(env_mod.starts(), fn s0 ->
      traj_truep = Synthex.Oracle.collect(s0, :truep, hd(env_mod.actions()), List.last(env_mod.actions()), env_mod, eval_fn, 30, %{})
      traj_falsep = Synthex.Oracle.collect(s0, :falsep, hd(env_mod.actions()), List.last(env_mod.actions()), env_mod, eval_fn, 30, %{})
